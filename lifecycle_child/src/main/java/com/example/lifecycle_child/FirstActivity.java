...
import com.example.lifecycle_child.fragment.AvpFragment;
import com.example.lifecycle_child.fragment.SdFragment;
    ...
    private void initView(){
        ...
        avp_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LifecycleApplocation.mapTypeViewModel.getMapTypeMutableLiveData().postValue(MapType.AVP);
            }
        });
        sd_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LifecycleApplocation.mapTypeViewModel.getMapTypeMutableLiveData().postValue(MapType.SD);
            }
        });
    }
}